...
import { FiCalendar, FiClock, FiUser, FiMessageSquare, FiCheckCircle } from "react-icons/fi";
      ...
      <div className="max-w-md mx-auto py-16 px-4 text-center">
        ...
        <div className="bg-gray-50 p-6 rounded-lg text-left mb-8">
          ...
          <div className="space-y-3">
            ...
            {formData.occasion && (
              <p><span className="text-gray-600">Occasion:</span> {formData.occasion}</p>
            )}
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="font-medium text-gray-900 mb-3">Availability Tips</h3>
            ...
            <div className="bg-amber-50 p-6 rounded-lg border border-amber-100">
              <h3 className="font-medium text-gray-900 mb-3">Planning an event?</h3>
              <p className="text-sm text-gray-600 mb-4">
                Our private dining room seats up to 20 guests with customized menus.
              </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-sm text-gray-600 mb-2">
                Call us directly at <a href="tel:+1234567890" className="text-amber-600 hover:underline">(123) 456-7890</a>
              </p>
              <p className="text-sm text-gray-600">
                Or email <a href="mailto:reservations@savorly.com" className="text-amber-600 hover:underline">reservations@savorly.com</a>
              </p>
            </div>
          </div>
        </div>
