          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <FiClock className="h-6 w-6 text-amber-600 mt-1" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <FiPhone className="h-6 w-6 text-amber-600 mt-1" />
                <div>
              ...
              <div className="flex items-start gap-4">
                <FiMail className="h-6 w-6 text-amber-600 mt-1" />
                <div>
          ...
          <div>
            <div className="bg-gray-50 rounded-xl p-6 md:p-8">
              ...
              <form className="space-y-5">
                ...
                <button
                  type="submit"
                  className="w-full bg-amber-600 hover:bg-amber-700 text-white py-3 px-4 rounded-md font-medium transition-colors flex items-center justify-center gap-2"
                >
                  <FiSend />
                  Send Message
                </button>
            ...
            {/* Newsletter Signup */}
            <div className="mt-8 bg-amber-50 rounded-xl p-6 md:p-8 border border-amber-100">
              ...
              <form className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="bg-amber-600 hover:bg-amber-700 text-white py-2 px-4 rounded-md font-medium transition-colors whitespace-nowrap"
                >
                  Subscribe
                </button>
              </form>
