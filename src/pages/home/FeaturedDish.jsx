  ...
  const dishes = [
    {
      ...
      price: "$24",
      image:
        "https://images.unsplash.com/photo-1642354609876-5386fea5e7fc?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8VHJ1ZmZsZSUyMFBhc3RhfGVufDB8fDB8fHww",
    ...
    },
    {
      ...
      price: "$42",
      image:
        "https://images.unsplash.com/photo-1546964124-0cce460f38ef?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8UmliZXllfGVufDB8fDB8fHww",
      badges: ["signature", "gf"],
    ...
    },
    {
      ...
      price: "$58",
      image:
        "https://images.unsplash.com/photo-1613585179451-6cce8644d8b9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8U2VhZm9vZCUyMFRvd2VyfGVufDB8fDB8fHww",
      badges: ["seasonal", "gf"],
      ingredients: [
        "East Coast lobster",
        "Pacific oysters",
    ...
    },
    {
      ...
      price: "$22",
      image:
        "https://plus.unsplash.com/premium_photo-1694850980351-683bd8436024?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDF8fFdpbGQlMjBNdXNocm9vbSUyMFJpc290dG98ZW58MHx8MHx8fDA%3D",
    ...
    },
    {
      ...
      price: "$14",
      image:
        "https://images.unsplash.com/photo-1540889539617-6236fa68e2f0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Q2hvY29sYXRlJTIwU291ZmZsJUMzJUE5fGVufDB8fDB8fHww",
      badges: ["signature"],
    ...
    },
    {
      ...
      price: "$36",
      image:
        "https://images.unsplash.com/photo-1494329157681-b2a3c7ff8aed?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fEhlcmIlMjBDcnVzdGVkJTIwbWVhdHxlbnwwfHwwfHx8MA%3D%3D",
      badges: ["gf"],
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Our most beloved dishes</p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {dishes.map((dish) => (
                ...
                >
                  ...
                  {/* Bottom Info */}
                  <div className="absolute bottom-0 left-0 right-0 px-6 py-14 text-white transition-all duration-300 group-hover:translate-y-0 translate-y-8">
